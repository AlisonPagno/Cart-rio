...
int registro()          //Função que cria o cadastro do cliente no sistema
{
	//inicio variável/string
	char arquivo[40];  
	char cpf[40];
	char nome[40];
	char sobrenome[40];
	...
	strcpy(arquivo, cpf); //responsável por copiar os arquivos da string
	
	FILE *file; //criando arquivo na pasta
	file= fopen (arquivo, "w");  //criação para escrever
